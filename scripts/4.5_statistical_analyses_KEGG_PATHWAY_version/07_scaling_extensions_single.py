...
OUTPUT_DIR = BASE_DIR / "results/4.5_statistical_analyses_KEGG_PATHWAY_version/07_extensions"
...
try:
    base_name_parquet = f"master_table_env_filtered{suffix}.parquet"
    INPUT_FILE = BASE_DIR / f"results/4.5_statistical_analyses_KEGG_PATHWAY_version/02_env_cohorts/{prefix}{base_name_parquet}"
    base_name_tsv = f"master_table_env_filtered{suffix}.tsv"
    INPUT_FILE_TSV = BASE_DIR / f"results/4.5_statistical_analyses_KEGG_PATHWAY_version/02_env_cohorts/{prefix}{base_name_tsv}"
...
# Write QC log
base_name_log = f"qc_07_extensions_test{suffix}.log" if args.test_mode else f"qc_07_extensions{suffix}.log"
